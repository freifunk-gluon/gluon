...
static void count_stations(size_t *wifi24, size_t *wifi5, size_t *owe24, size_t *owe5, size_t *owe6) {
	...
	uci_foreach_element(&p->sections, e) {
		...
		count_iface_stations(wifi24, wifi5, owe6, ifname);
	}
...
static struct json_object * get_clients(void) {
	size_t wifi24 = 0, wifi5 = 0, owe24 = 0, owe5 = 0, owe6 = 0;

	count_stations(&wifi24, &wifi5, &owe24, &owe5, &owe6);
