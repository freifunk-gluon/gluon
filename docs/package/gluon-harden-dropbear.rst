...
if furthermore no SSH key is authorized to login, the service dropbear is disabled.
...
As *gluon-reconfigure* and a reboot happen upon leaving the setup-mode, no further steps are required.
