...
of scalability. See :doc:`gluon-firewall-filter-multicast` and
...
recommended to add the :doc:`gluon-firewall-filter-multicast`
package. Also, with the *mesh-batman-adv-15* feature,
:doc:`gluon-firewall-limit-arp` is selected by default.
