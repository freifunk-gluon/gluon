...
This is a hotfix release to fix the wrong htmode choice.
This was introduced through a casting mistake which is solved in this release.
...
- Fix channel width selection  (`#3797`_)
