...
The :doc:`../package/gluon-mesh-batman-adv-brmldproxy` package can be used to reduce overhead in
...
- Tunneldigger Mesh VPN support has been dropped (`#3109`_)
  ...
  Tunnerdigger support was deprecated in Gluon v2023.2 and has been subsequently moved to
  `community-packages
