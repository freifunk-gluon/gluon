...
- Devices using additional USB drivers of the community config switch the interface order (`#3576`_)

- The wireless phy pci path migration of Cudy WR3000 devices introduced in openwrt-24.10 happens too late, breaking wifi config for these devices.
